...
//Some methods in this class are inspired by the Earthquake app that Udacity made (available here: https://github.com/udacity/ud843-QuakeReport/tree/lesson-four)

public class NetworkUtils {

    static final private String LOG_TAG = NetworkUtils.class.getSimpleName();
    //In the line above, we cannot use Networking.this, because "this" cannot be referenced from a static context
